          ...
          <div class="patImg">
            <div v-for="item in attaList" class="thumb">
              <img :src="item.attaFileUrl" alt=""
                   @click.stop="bigImg(item.attaFileUrl)" @load="loadImage">
            </div>
          </div>
          <div class="createDiv">
            <span class="mfc create">
              ...
              <span>{{consultInfo.consulterName}} </span>
            </span>
        ...
        <ul>
          <li v-for="(item,index) in aboutReplyMessage" ref="chatLi">
            <div class="other" :class="{mysay:item.consultMessage.replierType == 'PAT'}">
              <img :src="item.userPat.patAvatar" alt="" v-if="item.consultMessage.replierType == 'PAT' && item.userPat.patAvatar">
              <img src="../../../static/img/pat-m.png" alt="" v-else-if="item.consultMessage.replierType == 'PAT' && !item.userPat.patAvatar">
              ...
              <div class="whatsay" ref="playaudio" @click="play(item,index)">
                ...
                <div class="whatsay_text playerArea" v-else-if="item.consultMessage.replyContentType == 'AUDIO'">
                  <audio :src="item.consultMessage.replyContent" alt=""></audio>
...
<script type="text/ecmascript-6">
  ...
  import {Todate,exactTime,goodTime,convertms} from '../../lib/filter'
          ...
          if (data.code == 0) {
            ...
            this.$nextTick(() => {
              ...
              if (this.consultInfo.consultType == "PLATFORMPIC") {
                ...
                data.obj.userDocVo?  this.docId = data.obj.userDocVo.id : this.docId = ''
              }
