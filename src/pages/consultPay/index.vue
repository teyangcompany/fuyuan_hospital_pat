...
//      },
      ...
      goHosList(){
        this.$router.push({
          path:"/hosList",
          query:{from:'consultPay'}
        })
      },
      goTest(){
        this.$router.push({
          path: '/payItem/waitPay',
//          query: {hosId:this.hosList[this.hosIndex].yyid,hosName:this.hosList[this.hosIndex].yymc,patId:this.allPatient[this.index].patId,id:this.allPatient[this.index].id}
        })
        var attachContent = {
          ...
          idCard:this.allPatient[this.index].commpatIdcard,
