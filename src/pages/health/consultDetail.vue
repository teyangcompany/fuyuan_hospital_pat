<template>
    <div>
        <top class="noflex" title="咨询详情" ref="header">
            <i slot="back"></i>
        </top>
        <scroll :height="scrollHeight"  style="background: white" :data="articleObj">
            <div>
                ...
                <div class="date">
                    <span class="mfc reader">{{articleObj.viewCount}} 阅读</span>
...
<script type="text/ecmascript-6">
    ...
    export default{
        ...
        mounted(){
            ...
            api('smarthos.information.news.info',{
                token:this.token,
                id:this.id
            }).then(res=>{
                console.log(res,6666);
                if(res.succ){
                    this.articleObj = res.obj.informationNews
                }else {
                    alert(res.msg)
                }
            })
